...
/*Task 1: counterMaker()
  ...
  counter1 are nested functions while counter 2 is only one function.
  
  2. Which of the two uses a closure? How can you tell?
  counter1 uses closure because function counter reaches out to function countermaker to let count = 0;
...
function getInningScore(inningcb) {
  /*Your Code Here */
  //pass the inning function as an argument
  //return an object
  return {
    Home: inningcb(),
    Away: inningcb(),
